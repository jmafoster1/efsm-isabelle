...
lemma subsumption: "(Label t1 = Label t2 \<and> Arity t1 = Arity t2) \<Longrightarrow>
...
lemma bad_guards: "\<exists>i. can_take_transition t1 i r \<and> \<not> can_take_transition t2 i r \<Longrightarrow>
   \<not> subsumes t2 r t1"
  by (simp add: subsumes_def)

lemma inconsistent_updates: "\<exists>p2 p1. (\<exists>i. posterior_separate (Arity t1) (Guards t1) (Updates t2) i r = Some p2 \<and>
...
lemma accepting_sequence_accepts: "accepting_sequence e s r t [] = Some y \<Longrightarrow> accepts e s r t"
...
lemma accepting_sequence_posterior_sequence_not_none: "accepting_sequence e s d t [] \<noteq> None \<Longrightarrow>
...
lemma rejects_gives_no_accepting_sequence: "rejects e s r t \<Longrightarrow> accepting_sequence e s r t [] = None"
...
lemma rejects_gives_no_posterior_sequence: "rejects e s d t \<Longrightarrow> posterior_sequence e s d t = None"
  using posterior_sequence_gives_accept by blast

lemma no_accepting_sequence_rejected: "accepting_sequence e s d t seq = None \<longrightarrow> rejects e s d t"
